package com.portalm.controller.${packageName}.${objectNameLower};
...
import com.portalm.controller.base.BaseController;
import com.portalm.entity.Page;
import com.portalm.util.AppUtil;
import com.portalm.util.ObjectExcelView;
import com.portalm.util.PageData;
import com.portalm.util.Jurisdiction;
import com.portalm.util.Tools;
import com.portalm.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.portalm.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
