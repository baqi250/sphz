package com.sphz.dao.redis.impl;
...
import com.sphz.dao.AbstractBaseRedisDao;
import com.sphz.dao.redis.RedisDao;
import com.sphz.util.DbFH;
...
public class RedisDaoImpl extends AbstractBaseRedisDao<String, PageData> implements RedisDao{
	...
	/**删除
	 * (non-Javadoc)
	 * @see com.sphz.dao.redis.RedisDao#delete(java.lang.String)
	 */
	@Override
	...
	/**删除多个
	 * (non-Javadoc)
	 * @see com.sphz.dao.redis.RedisDao#delete(java.util.List)
	 */
	@Override
	...
	/**修改
	 * (non-Javadoc)
	 * @see com.sphz.dao.redis.RedisDao#eidt(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/**通过key获取值
	 * (non-Javadoc)
	 * @see com.sphz.dao.redis.RedisDao#get(java.lang.String)
	 */
	@Override
