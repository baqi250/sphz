package com.sphz.controller.system.head;
...
public class HeadController extends BaseController {
	...
	public Object getList() {
		...
		try {
			...
			if(null == pds){
				Session se= Jurisdiction.getSession();
		...
		/*	if(null != strWEBSOCKET && !"".equals(strWEBSOCKET)){
			...
			List<PageData>pds1= messageService.listAll(pd);
			map.put("messageCount",pds1.size());
			map.put("pds1",pds1);
