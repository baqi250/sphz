package com.sphz.controller.information.pictures;
...
//		} // 校验权限
		...
		String fileName = "";
		PageData pd = new PageData();
		String notice_id = request.getParameter("notice_id");// 通知公告id
		Map<String, Object> propsMap = FtpUtils.getFtpProperties();// ftp配置
		InputStream inStream = null;
		inStream = file.getInputStream();
		// String basePath="message";//设置服务器中文件保存的根目录
		String basePath = (String) propsMap.get("noticebasepath");// 设置服务器中文件保存的根目录
		Date now = new Date();
