...
*/
public class Const {
	public static final String LayerInfo = "admin/config/config.txt";		//图层配置文件名称
	...
	public static final String SESSION_NUMBER = "CNM";					//用户编码
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((plugins)|(login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)).*";	//不对匹配该值的访问路径拦截（正则）
