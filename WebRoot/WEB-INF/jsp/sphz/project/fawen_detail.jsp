...
<head>
    ...
    <link rel="stylesheet" href="plugins/xha/dist/css/pages/tablelist.css">
...
<body class="hold-transition skin-blue sidebar-mini">
		...
		<input type="hidden" value="${pd.whwym}" id="whwym">
    ...
    <!-- Custom js -->
    <script src="plugins/xha/dist/js/pages/tablelist.js "></script>
     <script src="plugins/xha/plugins/layer/layer.js"></script>
     <script type="text/javascript">
     	 //$("#detailDiv").tablelist();
     	 $.ajax({
		            type: "POST",
		            url: "sphz/project/getFawenDetails",
		            data: {
		                "whwym": $("#whwym").val()
		            },
		            dataType: "json",
		            success: function(response) {
		            	...
		            	$("#detailDiv").tablelist({title:response.title,BaojianData:response.BaojianData,FawenData:response.FawenData,ZhibiaoType:response.ZhibiaoType,ZhibiaoData:response.ZhibiaoData});
