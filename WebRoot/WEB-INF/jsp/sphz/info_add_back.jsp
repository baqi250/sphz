                            ...
                            <div class="box-body">
                                ...
                                <!-- <form role="form" > -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="PROJ_LOCATION" name="PROJ_LOCATION" value="${pd.PROJ_LOCATION }" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="">建设单位</label>
                                        <input type="text" id="PROJ_UNIT" name="PROJ_UNIT" value="${pd.PROJ_UNIT }" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="">组织机构代码</label>
                                        <input type="text" id="ORG_CODE" name="ORG_CODE" value="${pd.ORG_CODE }" class="form-control">
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="">申请人姓名</label>
                                                <input type="text" id="APPLICANT_NAME" name="APPLICANT_NAME" value="${pd.APPLICANT_NAME }" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="">申请人电话</label>
                                                <input type="text" class="form-control" id="APPLICANT_PHONE" name="APPLICANT_PHONE" value="${pd.APPLICANT_PHONE }" data-inputmask="'mask': '999-9999-9999'">
                                            </div>
                                        </div>
                                    </div>
                               <!--  </form> -->
                              ...
                              <!--   <form role="form" action="sphz/addJbxx.do" name="jbxxForm" id="jbxxForm" method="post"> -->
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="">经办人</label>
                                                <input type="text" name="OPERATOR" id="OPERATOR" value="${pd.OPERATOR }" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                              <!--   </form> -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group input-group">
                                                <label for=""></label>
                                                <%-- "${null==pd.LAND_USE_NAME||''==pd.LAND_USE_NAME?'请选择':pd.LAND_USE_NAME}" --%>
