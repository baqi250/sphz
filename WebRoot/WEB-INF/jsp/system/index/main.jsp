...
<body class="hold-transition skin-blue sidebar-mini sidebar-collapse" style="height:100% !important">
    <div class="wrapper" style="height:100% !important">
		...
		<!-- <div style="height:100%;margin-left: 260px"> -->
		<div class="content-wrapper">
			<iframe name="mainFrame" id="mainFrame" frameborder="0" src="login_default.do" style="margin:0 auto;width:100%;height:calc(100% - 3px); "></iframe>
		</div>
     </div>
    <!-- REQUIRED JS SCRIPTS -->
...
<!--     Custom js
    ...
    <script type="text/javascript">
    		...
    		function js_method(new_url){
    			/* var old_url= $("#mainFrame").attr("src");
    			if(new_url==old_url){
