	...
	<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								<form action="panorama/${msg }.do" name="panoramaForm" id="panoramaForm" method="post" enctype="multipart/form-data">
									<input type="hidden" name="panorama_id" id="panorama_id" value="${pd.panorama_id }"/>
									...
									<%-- 	<tr>
										...
										<tr>
											...
											<td>
												...
												<input readonly="readonly" class="form-control" type="text" name="photo_date" id="photo_date" value="${pd.photo_date}" maxlength="100" placeholder="这里输入发布日期" title="发布日期:" style="width:100%;"/>
										...
										<tr>
											<td style="width:90px;text-align: right;padding-top: 13px;">全景地址:</td>
											<td><input type="text" name="panorama_url" id="panorama_url" value="${pd.panorama_url }" maxlength="100" placeholder="这里输入全景地址" title="全景地址" style="width:100%;"/></td>
										</tr>
										
										<tr>
											<td style="width:90px;text-align: right;padding-top: 13px;">图片文件:</td>
